...
// ============================================
// BEAUTIFUL MOBILE TABLE RENDERING
// ============================================
function populateResultsBeautiful() {
    const tbody = document.getElementById('resultsBody');
    if (!tbody) return;
    ...
    const resultsCount = document.getElementById('resultsCount');
    if (resultsCount) {
        resultsCount.textContent = `📊 ${totalGames} winning picks`;
    }
}

// Override
populateResults = populateResultsBeautiful;
